var Data = {
    ...
    SOUNDS: {
        ...
        'teldoGasm': [
            {name: 'aaaah'},
            {name: 'haaan_aaah_oooh'},
            {name: 'ooooh'},
            {name: 'ooouuu'},
            {name: 'aaaahh'},
            {name: 'awwhh'}],
        'teldoHappy': [
            {name: 'lets_fuck_him_up'},
            {name: 'papadadaduduu'},
            {name: 'timmy'},
            {name: 'weee'},
            {name: 'hmm_hm_hm_hm'},
            ...
            {name: 'aww yeaa'}],
        'other': [
            {name: 'holy_macaroni', im: '.png'},
            {name: 'time_to_shiiiine', im: '.png'},
            {name: 'oh_fo_fuk_sake', im: '.png'},
            {name: 'sensei_sama', im: '.png'},
            {name: 'wow', im: '.png'},
            {name: 'thanks_for_the_follow', im: '.png'},
            {name: 'good_game', im: '.png'},
            {name: 'sanic', im: '.png'},
            ...
            {name: 'shifuu', im: '.png'},
            {name: 'upside_down', im: '.png'}],
        'battlerekt': [
            {name: 'tel_rosk_mi'},
            {name: 'double_bubble_double_trouble'},
            {name: 'he_might_just_be_straight_up_dead'},
            {name: 'how_did_this_happen'},
